...
<div style="background-color:white;color:black;border:10px solid black;border-radius:12px;font-size:17;border-radius:14px;margin-left:2px;width:100.1%;"><b>  Casts: </b>{{$series->cast}} <br><b>Genres: </b> {{$series->genre}} <br><b>Run Time:</b> {{$series->runtime}} mins<br><b>Views: </b>{{$series->series_views}} <br><b>Ratings: </b>{{$series->rating}} <br><b>Seasons:</b> {{$count}}
