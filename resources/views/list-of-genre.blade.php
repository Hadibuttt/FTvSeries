...
@for ($i = 1; $i <= 20; $i++)
    <img src="https://img.icons8.com/doodle/48/000000/circled-right-2.png" style="height:25px;"> <a href="Select genre.php" style="color:darkslategray;font-size:19px;"><b>Action</b></a><br>
@endfor
